  ...
  return (
    ...
    >
      ...
      <li className="last">
        <Link
          to="/neighborhood"
          className={pathname === "/neighborhood" ? "ui-active" : undefined}
        >
          Neighborhood
        </Link>
      </li> 
      <li className="last">
        <Link
          to="/floorplan"
          className={pathname === "/floorplan" ? "ui-active" : undefined}
        >
          Floor Plans
        </Link>
      </li>
      <li className="last">
        <Link
          to="/gallery"
          className={pathname === "/gallery" ? "ui-active" : undefined}
        >
          Gallery
        </Link>
      </li>
      ...
      <li className={`list-inline-item add_listing ${float}`}>
        <Link to="/create-listing">
          ...
          <span className="dn-lg"> Call Now</span>
        </Link>
      </li>
      {/* End .dropitem */}
    </ul>
